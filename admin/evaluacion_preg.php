...
echo "<a href='evaluacion.php?categoria=$categoria&titulo=$titulo'><button type='button' class='btn btn-default, btn btn-success'> <i class='fas fa fa-times fa-1x'></i> CANCELAR </button></a>";
?>

<input type="hidden" name="id_preguntas" value="<?php echo $id_preguntas;?>">
<input type="hidden" name="categoria" value="<?php echo $categoria;?>">
<input type="hidden" name="titulo" value="<?php echo $titulo;?>">
<button type="submit" class="btn btn-danger"><i class="fas fa-trash-alt fa-1x"></i> ELIMINAR</button>
</form>
