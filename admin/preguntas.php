...
$titulo=$_GET['titulo'];
echo "<a href='evaluacion.php?id=$id&categoria=$categoria&titulo=$titulo'><button type='button' class='btn btn-info' ><i class='fas fa fa-reply fa-1x'></i> REGRESAR ATRÁS</button></a>";
?>
...
<tr>
<td colspan="3"></td><td><button type="submit" class="btn btn-success" ><i class="fas fa fa-save fa-1x"></i> GUARDAR</button></td>
</tr>
