...
<div class="table-responsive">
 <h3 class="text-center" >!!Recuerda que si <b> MODIFICAS LA CONTRASEÑA</b> del estudiante tendrás que <b>GUARDARLO DE NUEVO</b> en la evaluación </h3>
<p class="text-center"><b>Alumnos del Aula: </b><?php echo $curso."<b>*Grupo: </b> ".$paralelo."<b>*Nivel: </b> ".$nivel."  <b>*Colegio: </b>".$colegio;?></p>
...
echo "<td><a href='alum_eliminar.php?id=$id_alumno'><button type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='bottom' title='Eliminar'><i class='fas fa-trash-alt'></i></button></a></td>";
echo "</tr>";
$numero++;		
	}
}
...
<tr>
	<td colspan="2">
	<a href="index.php"><button type='button' class='btn btn-info btn-lg'><i class="fas fa fa-reply"></i> Regresar </button></a> || 
	<button type='submit' class='btn btn-dark btn-lg'><i class="far fa-save"></i> Guardar Participantes </button></td>
</tr>
</tbody>
</form>
</table>
