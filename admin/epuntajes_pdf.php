...
$pdf->Ln(10);
$pdf->Image('imagenes/logoutt.jpg' , 10 ,10, 25 , 23,'JPG');
$pdf->Cell(35, 10, '', 0);
$pdf->Cell(125, 10, 'EVALUACIÓN DIGITAL_STAR', 0,0,'C');//IMPORTANTE TRABAJAR CON 1 PARA VER LOS CUADROS

$pdf->Image('imagenes/Logo-vertical.png', 170 ,10, 40 , 20);
$pdf->Ln(15);

$pdf->SetFont('Arial', '', 10);
$pdf->Cell(5, 8, '', 0);
$pdf->Cell(95, 8, 'TITULO: '.$titulo, 1);

$fecha=date("d/m/Y",strtotime($fecha_final));


//$pdf->Cell(95, 8, utf8_decode('CAMPOS DE SABERES: '.$area), 1);
$pdf->Cell(95, 8,  'Fecha de termino del examen : '.$fecha, 1);
$pdf->Ln(8);
...
$pdf->Cell(5, 8, '', 0);
$pdf->Cell(95, 8, 'GRADO: '.$curso.' de '.$nivel.' '.$paralelo, 1);
...
$pdf->Cell(95, 5, 'V A L O R A C I O N E S  D E  L A  E V A L U A C I Ó N ', 1,0,'C',True);
...
$pdf->Cell(73, 8, 'OBSERVACIONES', 1,0,'C',True);
...
//Modifique aca para imprimir el reporte de calificaciones cuando fuera 0
if($act1==0 && $act2==0 && $act3==0 && $act4==0 && $act5==0 && $act6==0 && $act7==0 && $act8==0 && $act9==0 && $act10==0){
    $total=0;
    $promed=0;
}else{
